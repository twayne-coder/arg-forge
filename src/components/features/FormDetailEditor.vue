    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div class="flex flex-col">
          ...
          <div class="flex items-center justify-between">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger as-child>
                <Button size="sm" class="h-7 px-2 text-sm">
                  <PlusIcon class="h-3.5 w-3.5 mr-1" />
                  {{ $t('formItem.addItem') }}
                  <ChevronDownIcon class="h-3.5 w-3.5 ml-1" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
        ...
        <div class="px-3 pt-3 pb-2 space-y-2">
          <!-- 拖拽区域 -->
          <div ref="listRef" class="space-y-2 pb-3">
            <FormItemEditor
          ...
          >
            <div class="flex flex-col items-center gap-2">
              ...
              <p class="text-xs">{{ $t('formItem.noItems') }}</p>
              <DropdownMenu>
                <DropdownMenuTrigger as-child>
